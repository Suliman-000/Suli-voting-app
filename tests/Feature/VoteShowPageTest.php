...
class VoteShowPageTest extends TestCase
{
    ...
    public function test_show_contains_idea_show_livewire_component()
    {
    ...
    public function test_user_who_is_logged_in_shows_voted_if_idea_already_voted_for_in_show_page()
    {
        $user = User::factory()->create();
